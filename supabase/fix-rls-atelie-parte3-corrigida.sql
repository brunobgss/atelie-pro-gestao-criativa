-- =====================================================
-- PARTE 3 CORRIGIDA: REMOVER E RECRIAR POLÍTICAS
-- =====================================================
...
-- Remover políticas existentes de user_empresas
...
-- Remover políticas existentes de empresas
...
SELECT 'Políticas para empresas e usuários criadas com sucesso!' as status;
